...
class MovieResponse {
  ...
  set belongsToCollection(BelongsToCollection? belongsToCollection) =>
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this._belongsToCollection != null) {
      data['belongs_to_collection'] = this._belongsToCollection!.toJson();
    }
