...
class _$MovieDetailImpl with DiagnosticableTreeMixin implements _MovieDetail {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'MovieDetail(adult: $adult, backdropPath: $backdropPath, backdropUrl: $backdropUrl, belongsToCollection: $belongsToCollection, budget: $budget, genres: $genres, homepage: $homepage, id: $id, imdbId: $imdbId, originCountry: $originCountry, originalLanguage: $originalLanguage, originalTitle: $originalTitle, overview: $overview, popularity: $popularity, posterPath: $posterPath, productionCompanies: $productionCompanies, productionCountries: $productionCountries, releaseDate: $releaseDate, revenue: $revenue, runtime: $runtime, spokenLanguages: $spokenLanguages, status: $status, tagline: $tagline, title: $title, video: $video, voteAverage: $voteAverage, voteCount: $voteCount)';
  }
...
abstract class _MovieDetail implements MovieDetail {
  const factory _MovieDetail(
      ...
      final bool? video,
      final double? voteAverage,
      final int? voteCount}) = _$MovieDetailImpl;
